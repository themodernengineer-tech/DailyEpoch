...
| 011 | 2026-09-23 | ☁️ Cloud & AI Platforms | **AWS AI Practitioner — AWS Managed AI Services** | Pre-built AWS AI services enable applications to add AI capabilities without training custom models. | Studied AWS services for vision, NLP, speech, translation, document processing, and conversational AI. | [📘 Notes](https://github.com/themodernengineer-tech/CloudAtlas/blob/main/21-aws-certified-ai-practitioner/awsai_9_managed_ai.pdf) |
